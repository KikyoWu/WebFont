- [09-HTML5举例：简单的视频播放器.md](#09-html5举例简单的视频播放器md)

# 09-HTML5举例：简单的视频播放器.md

我们采用 Bootstrap 网站的图标字体，作为播放器的按钮图标。

因为`test/css/font-awesome.min.css`文件中有`{font-family:'FontAwesome';src:url('../font/fontawesome-webfont.eot?v=3.2.1');...`,所以需要将font文件添加到css所在文件夹的同级文件夹font下，才会显示正确的播放，全屏按钮。
    ...
    <style>
        *{
        ...
        .palyer{
            ...
            background: url('test/image/pkq.gif') center no-repeat #000;   /*加不加''都能正常运行*/
            background-size:auto 100%;
            position: relative; /*position 属性规定元素的定位类型。relative	
...
<body>
    ...
    <figure>
        ...
        <div class="palyer">
            <video src="test/video/fun.mp4"></video>
            <!-- 控制条-->
            <div class="controls">
                <!-- 播放暂停-->
