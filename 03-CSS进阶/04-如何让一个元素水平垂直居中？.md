- [04-如何让一个元素水平垂直居中？](#04-如何让一个元素水平垂直居中)
  - [前言](#前言)
  - [如何让一个行内元素（文字、图片等）水平垂直居中](#如何让一个行内元素文字图片等水平垂直居中)
    - [行内元素水平居中](#行内元素水平居中)
    - [行内元素垂直居中](#行内元素垂直居中)
  - [如何让一个块级元素水平垂直居中](#如何让一个块级元素水平垂直居中)
    - [margin: auto 的问题](#margin-auto-的问题)
    - [方式一：绝对定位 + margin（需要指定子元素的宽高，不推荐）](#方式一绝对定位--margin需要指定子元素的宽高不推荐)
    - [方式二：绝对定位 + translate（无需指定子元素的宽高，推荐）](#方式二绝对定位--translate无需指定子元素的宽高推荐)
    - [方式3：flex 布局（待改进）](#方式3flex-布局待改进)
    - [方式4： flex 布局 + margin: auto（推荐）](#方式4-flex-布局--margin-auto推荐)
  - [垂直居中的典型应用场景：红包幕帘/弹窗](#垂直居中的典型应用场景红包幕帘弹窗)
    - [问题引入](#问题引入)
    - [移动端，红包幕帘/弹窗 居中的规范写法（非常标准）](#移动端红包幕帘弹窗-居中的规范写法非常标准)
  - [最后一段](#最后一段)
  - [参考链接](#参考链接)
...
[![img](https://camo.githubusercontent.com/7101dbe0ab6b8bf4bc98408be7a823413f997bbd6ee97d1b5f6c5d229fb33f9c/687474703a2f2f696d672e736d79687661652e636f6d2f32303139313031305f313531302e706e67)](https://camo.githubusercontent.com/7101dbe0ab6b8bf4bc98408be7a823413f997bbd6ee97d1b5f6c5d229fb33f9c/687474703a2f2f696d672e736d79687661652e636f6d2f32303139313031305f313531302e706e67)
...
- [margin:auto实现绝对定位元素的水平垂直居中](http://www.zhangxinxu.com/wordpress/2013/11/margin-auto-absolute-绝对定位-水平垂直居中/)