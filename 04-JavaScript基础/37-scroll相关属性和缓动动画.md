- [37-scroll相关属性和缓动动画](#37-scroll相关属性和缓动动画)
  - [scroll 相关属性](#scroll-相关属性)
    - [window.onscroll() 方法](#windowonscroll-方法)
    - [1、ScrollWidth 和 scrollHeight](#1scrollwidth-和-scrollheight)
    - [2、scrollTop 和 scrollLeft](#2scrolltop-和-scrollleft)
    - [scrollTop 的兼容性](#scrolltop-的兼容性)
    - [判断是否已经 DTD 声明](#判断是否已经-dtd-声明)
    - [将 scrollTop 和 scrollLeft 进行封装](#将-scrolltop-和-scrollleft-进行封装)
  - [获取 html 文档的方法](#获取-html-文档的方法)
  - [scrollTop 举例：固定导航栏](#scrolltop-举例固定导航栏)
  - [缓动动画](#缓动动画)
    - [三个函数](#三个函数)
    - [缓动动画的原理](#缓动动画的原理)
    - [缓慢动画的封装（解决四舍五入的问题）](#缓慢动画的封装解决四舍五入的问题)
  - [window.scrollTo()方法举例：返回到顶部小火箭](#windowscrollto方法举例返回到顶部小火箭)
...
![](../04-JavaScript基础/test/image/37_1.gif)
...
![](../04-JavaScript基础/test/image/37_2.png)
...
<div class="top" id="top">
    <img src="../image/宣传图.jpg" alt="123"/>
</div>
<div id="Q-nav1">
    <img src="../image/37_3.jpg" alt=""/>
</div>
<div class="main" id="main">
    <img src="../image/宣传图.jpg" alt=""/>
</body>
</html>
```
...
![实现效果](../04-JavaScript基础/test/image/37_4_固定导航栏.gif)
...
![](../04-JavaScript基础/test/image/37_5.gif)

### 缓慢动画的封装（解决四舍五入的问题）

我们发现一个问题，上图中的盒子最终并没有到达400px的位置，而是只到了396.04px就停住了：

![](../04-JavaScript基础/test/image/37_6.png)

原因是：JS在取整的运算时，进行了四舍五入。

我们把打印396.04px这个left值打印出来看看：

![](../04-JavaScript基础/test/image/37_7.png)
...
![](../04-JavaScript基础/test/image/37_8.gif)
    ...
    <script>
         window.onload = function () {
            ...
            window.onscroll = function () {
                ...
                leader = scroll().top;//滚动条相对于其顶部的偏移
            }
            ...
            img.onclick = function () {
                ...
                timer = setInterval(function () {
                    ...
                    if (Math.abs(target - img.offsetTop) <= Math.abs(step)) {
                        //处理小数赋值
                        img.style.top = target + "px";
                        clearInterval(img.timer);
                        img.removeAttribute('style');//消除style,使火箭变回原来位置，否则在顶端
                    }
                }, 25);
            }
        }
...
![](../04-JavaScript基础/test/image/37_10.gif)

小火箭的图片资源：

![小火箭](../04-JavaScript基础/test/image/37_9.jpg)
