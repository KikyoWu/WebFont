- [09-流程控制语句：选择结构（if和switch）](#09-流程控制语句选择结构if和switch)
  - [代码块](#代码块)
  - [流程控制语句](#流程控制语句)
    - [流程控制语句分类](#流程控制语句分类)
  - [顺序结构](#顺序结构)
  - [if 语句](#if-语句)
    ...
    - [做个题目](#做个题目)
    - [if 语句的嵌套](#if-语句的嵌套)
  - [switch 语句（条件分支语句）](#switch-语句条件分支语句)
    - [语法格式](#语法格式)
    - [switch 语句的执行流程](#switch-语句的执行流程)
    - [switch 和 case 后面的值（含代码举例）](#switch-和-case-后面的值含代码举例)
    - [switch 语句的结束条件【非常重要】](#switch-语句的结束条件非常重要)
    - [case 穿透](#case-穿透)
  - [switch 语句的实战举例：替换 if 语句](#switch-语句的实战举例替换-if-语句)
    - [写法 1（不推荐。这种写法太挫了）](#写法-1不推荐这种写法太挫了)
    - [写法 2（推荐。通过 return 的方式，将上面的写法进行改进）](#写法-2推荐通过-return-的方式将上面的写法进行改进)
    - [写法 3（推荐。将 if else 改为 switch）](#写法-3推荐将-if-else-改为-switch)
    - [switch 语句的优雅写法：适时地去掉 break](#switch-语句的优雅写法适时地去掉-break)
...
[![img](https://camo.githubusercontent.com/37e208d8d652e727a759bdf9dd0e023a6c94a7964164d9a6e496033322645800/687474703a2f2f696d672e736d79687661652e636f6d2f32303138313232375f313230302e706e67)](https://camo.githubusercontent.com/37e208d8d652e727a759bdf9dd0e023a6c94a7964164d9a6e496033322645800/687474703a2f2f696d672e736d79687661652e636f6d2f32303138313232375f313230302e706e67)
...
```
一个加油站为了鼓励车主多加油，所以加的多有优惠。92号汽油，每升6元；如果大于等于20升，那么每升5.9；97号汽油，每升7元；如果大于等于30升，那么每升6.95编写JS程序，用户输入自己的汽油编号，然后输入自己加多少升，弹出价格。
```

[![img](https://camo.githubusercontent.com/29282713e0d44f6b3c2a64dafb7739af9880700c4d38cb1a612f70518e5040b7/687474703a2f2f696d672e736d79687661652e636f6d2f32303138303131375f323233322e706e67)](https://camo.githubusercontent.com/29282713e0d44f6b3c2a64dafb7739af9880700c4d38cb1a612f70518e5040b7/687474703a2f2f696d672e736d79687661652e636f6d2f32303138303131375f323233322e706e67)
...
[![img](https://camo.githubusercontent.com/cd9ce03204fffb330d811f9df3df2689d71944f8eaaa6b3e4b4ce32b4ae5f5cb/687474703a2f2f696d672e736d79687661652e636f6d2f32303139303831355f313530312e706e67)](https://camo.githubusercontent.com/cd9ce03204fffb330d811f9df3df2689d71944f8eaaa6b3e4b4ce32b4ae5f5cb/687474703a2f2f696d672e736d79687661652e636f6d2f32303139303831355f313530312e706e67)
